...
本质上Session机制不属于HTTP协议中的一部分，用来弥补HTTP无状态的缺陷，Session机制是一种在客户端和服务端之间保持状态的一种解决方案，例如浏览网站时，服务端会校验客户端的请求报文中是否包含Session标志，如果有，则检索出来用来使用，不然则创建一个Session，并且作为应答发送给客户端
